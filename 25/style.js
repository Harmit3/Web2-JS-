...
//this is generic composition function.
...
function compose(...fns){       //------------------------------> here, it accepts unlimited functions
    return function(...values){                   //-------------> here, it accepts unlimited values(as type is arrays) that we passed in return function(a,b) in the above function
...
//you can write down above functions to arrow functions like below
/*
 const compose=
   (...fns)=>
   (...values)=>
...
/*function compose(...fns){      ---> came multiply,square,function(value){return value;} here
    return function(...values){           
        return fns.reduce((a,b)=>b(a),values);     --->a is multiply and b is sqauare and values came here (2.10) so perform a first and got ans 20 Then square it and got ans 400. 
        400 goes to value and add 1 and log it.------------------
                                                                |
                                                                |
    }                                                           |
}                                                               |
...
//               value goes here as an array in compose function values
